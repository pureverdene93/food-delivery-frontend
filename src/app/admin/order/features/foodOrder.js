          ...
          <div className="flex gap-3">
            ...
            >
              ...
              {countDeliveryState > 0 && (
                <div className="text-[12px] flex text-black bg-white font-semibold justify-center items-center rounded-2xl w-[26px] h-5">
                  {countDeliveryState}
                </div>
              )}
            </button>
            {deliveryState && countDeliveryState > 0 && (
              <div className="fixed z-50 bg-[rgba(0,0,0,0.5)] w-full h-full top-0 left-0 flex justify-center items-center">
